...
import { AppInfoRepository, skipWhileAppInfosCached } from 'src/app/shared/repositories/app-info.repository';
...
export class AppInfoService {
  ...
  public getAppInfo(): Observable<AppInfo> {
    ...
    return this.http.get<AppInfo>(url).pipe(
      ...
      skipWhileAppInfosCached('appInfo', { returnSource: of(null) }), // Needs returnSource or else control won't pass to next line when cache is full
